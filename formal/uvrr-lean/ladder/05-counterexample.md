# Rung 5: The cross-era frown is necessary (counterexample)

*2026-09-05T23:31:04Z by Showboat 0.6.1*
<!-- showboat-id: 1a275cef-61a6-4a7c-b605-5a88381c2e78 -->
...
```bash
lake build UVRR.Counterexample 2>&1 | tail -1
```
...
```bash
printf 'import UVRR.Counterexample\n#print axioms Counterexample.not_p1\n#print axioms Counterexample.two_chosen\n#print axioms Counterexample.cross_frown_necessary\n' | lake env lean --stdin
```

```output
'Counterexample.not_p1' does not depend on any axioms
'Counterexample.two_chosen' does not depend on any axioms
'Counterexample.cross_frown_necessary' depends on axioms: [propext, Quot.sound]
```
