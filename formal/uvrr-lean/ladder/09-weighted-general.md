# Rung 9: General weighted-majority intersection

*2026-09-06T07:32:53Z by Showboat 0.6.1*
<!-- showboat-id: b2607df4-29ae-4f1d-9e39-7fd74e28e3cc -->

Claim: UPaxos Appendix A Lemmas 2–4 and Corollary 5 for arbitrary finite support, positive natural scaling factors, and total scaled absolute difference at most one. A distance-two counterexample establishes sharpness of that uniform bound. The proof was completed locally after bounded Leanstral attempts did not produce a checked edit; see LAB-BOOK.md.

```bash
cat UVRR/WeightedGeneral.lean
```
...
```bash
set -euo pipefail; lake build UVRR.WeightedGeneral >/dev/null; echo "UVRR.WeightedGeneral built"
```

```output
UVRR.WeightedGeneral built
```

```bash
printf 'import UVRR.WeightedGeneral\n#print axioms WeightedGeneral.disjoint_bound\n#print axioms WeightedGeneral.scaled_overlap\n#print axioms WeightedGeneral.unit_change_overlap\n#print axioms WeightedGeneral.scaled_equal_overlap\n#print axioms WeightedGeneral.self_overlap\n#print axioms WeightedGeneral.distance_two_counterexample\n' | lake env lean --stdin
```

```output
'WeightedGeneral.disjoint_bound' depends on axioms: [propext, Classical.choice, Quot.sound]
'WeightedGeneral.scaled_overlap' depends on axioms: [propext, Classical.choice, Quot.sound]
'WeightedGeneral.unit_change_overlap' depends on axioms: [propext, Classical.choice, Quot.sound]
'WeightedGeneral.scaled_equal_overlap' depends on axioms: [propext, Classical.choice, Quot.sound]
'WeightedGeneral.self_overlap' depends on axioms: [propext, Classical.choice, Quot.sound]
'WeightedGeneral.distance_two_counterexample' depends on axioms: [propext, Classical.choice, Quot.sound]
```
