...
```bash
lake env lean UVRR/ViewFence.lean
```
...
```bash
printf 'import UVRR.ViewFence\n#print axioms ViewFence.reachable_inv\n#print axioms ViewFence.report_covers_vote\n#print axioms ViewFence.voter_history\n#print axioms ViewFence.selection_preserves\n#print axioms ViewFence.append_after_fence_breaks_history\n' | lake env lean --stdin
```

```output
'ViewFence.reachable_inv' depends on axioms: [propext, Classical.choice, Quot.sound]
'ViewFence.report_covers_vote' depends on axioms: [propext, Classical.choice, Quot.sound]
'ViewFence.voter_history' depends on axioms: [propext, Classical.choice, Quot.sound]
'ViewFence.selection_preserves' depends on axioms: [propext, Classical.choice, Quot.sound]
'ViewFence.append_after_fence_breaks_history' depends on axioms: [propext, Quot.sound]
```

```bash
printf 'import UVRR.ViewFence\n#print axioms ViewFence.all_later_views_preserve\n#print axioms ViewFence.two_view_application\n' | lake env lean --stdin
```

```output
'ViewFence.all_later_views_preserve' depends on axioms: [propext, Classical.choice, Quot.sound]
'ViewFence.two_view_application' depends on axioms: [propext, Classical.choice, Quot.sound]
```

The strong induction now discharges strictly-later-view preservation over the activated view set; inactive view numbers require no invented reports. Same-view provenance and report extension of the installed base remain explicit interfaces. A concrete two-view trace instantiates every hypothesis, checking that the interface admits a nonempty execution.
