# Rung 4: Era-indexed Paxos, Lemma 9 and Theorem 10

*2026-09-05T23:31:04Z by Showboat 0.6.1*
<!-- showboat-id: 8ded1d71-7bbd-4a8a-95c0-36dde885ff3d -->
...
```bash
lake build UVRR.Eras 2>&1 | tail -1
```
...
```bash
printf 'import UVRR.Eras\n#print axioms Paxos.lemma9\n#print axioms Paxos.toSynod_inv\n#print axioms Paxos.theorem10\n' | lake env lean --stdin
```

```output
'Paxos.lemma9' depends on axioms: [propext, Quot.sound]
'Paxos.toSynod_inv' depends on axioms: [propext, Quot.sound]
'Paxos.theorem10' depends on axioms: [propext, Quot.sound]
```
