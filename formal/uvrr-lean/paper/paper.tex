...
The result is a basis for replacing failed members while keeping synchronous
disk writes out of normal metadata replication.
\end{abstract}
...
The storage protocol must classify clean stops and durably fence identities before they send protocol messages. This paper abstracts that protocol as correct clean-stop classification and durable identity fencing. The Lean result concerns the resulting lifecycle; it does not model the storage protocol itself.
